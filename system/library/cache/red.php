...
class Red {
	...
	public function get($key) {
		return unserialize($this->cache->get(CACHE_PREFIX .'::'. $key));
	}
	...
	public function set($key,$value,$expire) {
		if(!empty($expire))
			return $this->cache->setex(CACHE_PREFIX .'::'. $key, $expire, serialize($value));
		else
			return $this->cache->setex(CACHE_PREFIX .'::'. $key, $this->expire, serialize($value));
	}
