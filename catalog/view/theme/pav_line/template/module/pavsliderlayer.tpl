...
?>
<?php if( $class =="boxed") { ?>
<div class="layerslider-wrapper" style="max-width:<?php echo $sliderParams['width'];?>px; padding: <?php echo $sliderParams['padding'];?>;margin: <?php echo $sliderParams['margin'];?>;">
<?php } ?>
			<div class="layerslider bannercontainer banner-<?php echo trim($class);?>">
						...
						<ul>
								...
								<div class="caption fade fullscreenvideo" data-autoplay="true" data-x="0" data-y="0" data-speed="500" data-start="10" data-easing="easeOutBack"><iframe src="<?php echo $vurl;?>?title=0&amp;byline=0&amp;portrait=0;api=1" width="100%" height="100%"></iframe></div>
										<?php }elseif( $slider['main_image'] ) { ?>
											...
											<img src="<?php echo $slider['main_image']; ?>"  alt=""/>
										<?php } ?>
										...
										<div class="caption <?php echo $layer['layer_class']; ?> <?php echo $layer['layer_animation'];?> 
											...
											<?php echo $layer['layer_endanimation'];?>"
											 ...
											 data-easing="easeOutExpo" <?php echo $endeffect;?> >
											 	<?php if( $type=='image') { ?> 
											 	<img src="<?php echo $url."image/".$layer['layer_content'];?>" alt="" />
												 	<?php } else if( $type == 'video' ) { ?>
												 		...
												 		<?php } else { ?>
												 			<iframe width="<?php echo $layer['layer_video_width'];?>" height="<?php echo $layer['layer_video_height'];?>" src="http://www.youtube.com/embed/<?php echo $layer['layer_video_id'];?>?wmode=transparent" frameborder="0" allowfullscreen></iframe>
											 		<?php } ?>
											 <?php	} else { ?>
