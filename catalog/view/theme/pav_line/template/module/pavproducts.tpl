...
<div class="box pav-categoryproducts no-padding no-box">
	...
	<div class="box-heading">
		<span><?php echo $module_description;?></span>
	</div>
	<?php } ?>
	...
	<div class="box-content">	
		...
		<div class="tab-content">  
			...
			?>
			<div class="tab-pane box-products products-rows <?php echo $category['class'];?> clearfix" id="tab-cattabs<?php echo $id.$category['category_id'];?>">	
			<?php if( count($products) > $itemsperpage ) { ?>
			<div class="carousel-controls">
				<a class="carousel-control left" href="#<?php echo $tab.$id.$category['category_id'];?>"   data-slide="prev"><i class="fa fa-angle-left"></i></a>
				<a class="carousel-control right" href="#<?php echo $tab.$id.$category['category_id'];?>"  data-slide="next"><i class="fa fa-angle-right"></i></a>
			</div>
			<?php } ?>
