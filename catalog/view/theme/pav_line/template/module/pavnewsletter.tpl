...
<div class="box<?php echo $prefix; ?> pav-newsletter" id="newsletter_<?php echo $position.$module;?>">
	<form id="formNewLestter" method="post" action="<?php echo $action; ?>" class="formNewLestter">	
        <div class="box-heading">	
            <span><?php echo $objlang->get("Sign up for newsletter");?></span>
        </div>
        <div class="description"><?php echo html_entity_decode( $description );?></div>
        	
        <div class="clearfix input-group">
            <input type="text" placeholder="Your email ..." class="form-control input-md inputNew email" <?php if(!isset($customer_email)): ?> <?php endif; ?> size="18" name="email">                            
        </div> 
