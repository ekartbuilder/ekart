  ...
  <div class="row"><?php if( $SPAN[0] ): ?>
   ...
   <div id="sidebar-main" class="col-md-<?php echo $SPAN[1];?>"><div id="content"><?php echo $content_top; ?>
      ...
      <div class="panel panel-default refine-search clearfix box white">
        <h3 class="panel-title"><?php echo $text_refine; ?> </h3> 
        ...
        <?php } else if ($categories) { ?>
          <div class="box box-normal refine-search clearfix">
          <div class="box-heading"><h3 class="panel-title"><?php echo $text_refine; ?></h3></div>
