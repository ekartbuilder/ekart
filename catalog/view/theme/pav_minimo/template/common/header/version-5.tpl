...
<?php  require( ThemeControlHelper::getLayoutPath( 'common/addon/topbar-v3.tpl' ) );?>

<header id="header-layout" class="header-v5">
  ...
  <div class="container"><div class="inside border-top">
    <div class="row">
      <div class="col-sm-12">
        <!-- menu -->
        <div id="pav-mainnav" class="pav-mainnav text-center"> <div class="pav-megamenu">
          <button data-toggle="offcanvas" class="btn btn-link canvas-menu hidden-lg hidden-md pull-left" type="button"><span class="fa fa-bars"></span> Menu</button>         
          <?php
          /**
