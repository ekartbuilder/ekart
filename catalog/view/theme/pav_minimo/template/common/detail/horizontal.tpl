<div class="col-lg-1 col-md-2 col-sm-3 col-xs-12 hidden-xs">
    ...
    <div class="image-additional slide carousel vertical" id="image-additional">
        ...
        if(count($images)>4){
        ?>
            <a class="carousel-control center top carousel-sm" href="#image-additional" data-slide="next">
                <i class="fa fa-angle-up"></i>
            </a>
            <a class="carousel-control center bottom carousel-sm" href="#image-additional" data-slide="prev">
