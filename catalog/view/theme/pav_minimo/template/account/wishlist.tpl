      ...
      <table class="table table-bordered table-hover">
        ...
        <tbody id="wishlist-row<?php echo $product['product_id']; ?>">
          <tr>
            ...
            <td class="text-right">
            <p>
              <button type="button" onclick="cart.addcart('<?php echo $product['product_id']; ?>');" data-toggle="tooltip" title="<?php echo $button_cart; ?>" class="btn btn-primary"><i class="fa-fw fa fa-shopping-cart"></i></button>
            </p>
              <a href="<?php echo $product['remove']; ?>" data-toggle="tooltip" title="<?php echo $button_remove; ?>" class="btn btn-danger"><i class="fa-fw fa fa-times"></i></a></td>
          </tr>
        </tbody>
        <?php } ?>
      </table>
