                    ...
                    <div id="product">
                        ...
                        <div class="product-meta clearfix">
                            ...
                            <div class="cart pull-left">
                                <button type="button" id="button-cart" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-inverse btn-primary border-2"><i class="fa-fw fa fa-shopping-cart"></i><?php echo $button_cart; ?></button>
                            </div>
                            <div class="wishlist pull-left">  
                                <button type="button" data-toggle="tooltip" class="wishlist btn btn-default btn-outline border-2" title="<?php echo $button_wishlist; ?>" onclick="wishlist.addwishlist('<?php echo $product_id; ?>');"><i class="fa-fw fa fa-heart"></i><span><?php echo $button_wishlist; ?></span></button>
                            </div>
                            <div class="compare pull-left">
                                <button type="button" data-toggle="tooltip" class="compare btn btn-default btn-outline border-2" title="<?php echo $button_compare; ?>" onclick="compare.addcompare('<?php echo $product_id; ?>');"><i class="fa-fw fa fa-refresh"></i><span><?php echo $button_compare; ?></span></button>
                            </div>                                                        
                        </div>
...
<div class="panel panel-default panel-v2 product-grid related container-inside bg-white space-top-20"> 
