        ...
        <div class="panel-body">
          <div class="row">
            ...
            <div class="col-sm-3"><strong>{{ store }}</strong><br />
              ...
              {% if geocode %}
              <a href="https://maps.google.com/maps?q=<?php echo urlencode($geocode); ?>&hl=en&t=m&z=15" target="_blank" class="btn btn-info"><i class="fa fa-map-marker"></i> {{ button_map }}</a>
              {% endif %}
            </div>
            ...
            <div class="panel-body">
              <div class="row">
                ...
                <div class="col-sm-3"><strong>{{ location.name }}</strong><br />
                  ...
                  {% if location.geocode %}
                  <a href="https://maps.google.com/maps?q=<?php echo urlencode($location.geocode); ?>&hl=en&t=m&z=15" target="_blank" class="btn btn-info"><i class="fa fa-map-marker"></i> {{ button_map }}</a>
                  {% endif %}
                </div>
                <div class="col-sm-3"> <strong>{{ text_telephone }}</strong><br>
