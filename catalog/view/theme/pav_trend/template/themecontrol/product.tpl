...
<style type="text/css">
	#footer,#powered, #pavo-mass-bottom, #header,.product-related,.producttabs,#sidebar-right,#page .show-mobile > div,.product-info .product-action .wishlist,.product-info .product-action .compare{
		display: none;
	}
	#sys-notification{
		padding-top:15px;
...
<?php 
	...
	$languageID = $this->registry->get( 'config_language_id' ); 
	$SPAN[0] = 0;
	$SPAN[1] = 12;
	$SPAN[2] = 0;   
?>
