...
<div class="row">
	<div class="blog-meta col-lg-3 col-md-3 col-sm-4 col-xs-12">
		...
		<li class="hits"><span class="fa fa-eye">   <?php echo $objlang->get("text_hits");?></span> <?php echo $blog['hits'];?></li>
		<?php } ?>
...
<?php if( $config->get('cat_show_title') ) { ?>
	...
	<?php } ?>
		...
		<div class="blog-readmore"><a href="<?php echo $blog['link'];?>" class="button"><?php echo $objlang->get('text_readmore');?></a></div>
		<?php } ?>
	</div>	
</div>
</div>