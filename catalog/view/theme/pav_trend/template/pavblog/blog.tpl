    ...
    <?php require( PAVO_THEME_DIR."/template/common/breadcrumb.tpl" );  ?>
		...
		<div class="content">
		 ...
		 <div class="row">
				...
				<div class="col-lg-6">
							<h3><?php echo $objlang->get('text_in_same_category');?></h3>
					<ul class="list">
				...
				<div class="col-lg-6">
							<h3><?php echo $objlang->get('text_in_related_by_tag');?></h3>
					<ul class="list">
							...
							<form action="<?php echo $comment_action;?>" method="post" id="comment-form" class="form-horizontal">
								<fieldset>
									...
									<div class="form-group required">
										<label class="col-sm-2 control-label" for="comment-user"><span class="required">*</span><?php echo $objlang->get('entry_name');?></label>
										<div class="col-sm-8">
									...
									<div class="form-group required">
										<label class="col-sm-2 control-label" for="comment-email"><span class="required">*</span><?php echo $objlang->get('entry_email');?></label>
										<div class="col-sm-8">
									...
									<div class="form-group required">
										<label class="col-sm-2 control-label" for="comment-comment"><span class="required">*</span><?php echo $objlang->get('entry_comment');?></label>
										<div class="col-sm-8">
