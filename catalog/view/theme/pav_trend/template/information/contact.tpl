      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal ">              
              ...
              <div class="buttons">
                <div class="pull-right">
                  <input class="button btn" type="submit" value="<?php echo $button_submit; ?>" />
                </div>
              </div>
              </fieldset>   
            ...
            <div class="panel-body">
              <div class="row">
                ...
                <div class="col-sm-3"><strong><?php echo $location['name']; ?></strong><br />
                  ...
                  <a href="https://maps.google.com/maps?q=<?php echo urlencode($location['geocode']); ?>&hl=en&t=m&z=15" target="_blank" class="btn button"><i class="fa fa-map-marker"></i> <?php echo $button_map; ?></a>
                  <?php } ?>
                </div>
