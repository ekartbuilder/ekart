	            ...
	            <div class="col-inner">
	                <?php foreach ( $col->widgets as $widget ){ ?>
	                    ...
	                    <div class="banner-wrapper">
	                    	<?php if($widget->link ){ ?>
                        	<a href="<?php echo $widget->link; ?>"><img src="<?php echo $url.'/image/'.$widget->image; ?>" alt="" class="img-responsive"></a>
                        	<?php }else { ?>
                        	<img src="<?php echo $url.'/image/'.$widget->image; ?>" alt="" class="img-responsive">
                        	<?php } ?>
                   		</div>
                   		<?php } ?>
	                <?php } ?>
