...
<div class="<?php echo $prefix;?> box productcarousel" id="module<?php echo $id; ?>">
	<div class="box-heading"><span class="pull-left"><?php echo $heading_title; ?></span><div class="bg-hedding pull-left"></div></div>
			...
			<div class="carousel-inner">		
				...
				<div class="item <?php if($k==0) {?>active<?php } ?>">
					<?php foreach( $tproducts as $i => $product ) {  $i=$i+1;?>
						...
						<?php } ?>
							<div class="col-sm-12 col-xs-12 <?php if($i%$cols == 0) { echo "last";} ?> product-col">
