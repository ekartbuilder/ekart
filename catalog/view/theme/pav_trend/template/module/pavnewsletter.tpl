<div class="<?php echo $prefix; ?> box newsletter_block" id="newsletter_<?php echo $position.$module;?>">
	<div class="row">
		<div class="col-sm-6 title_block"><?php echo $objlang->get("entry_newsletter");?></div>
	<!-- <div class="description"><?php echo html_entity_decode( $description );?></div> -->
		...
		<p class="wrap-input">
			...
			<input type="submit" name="submitNewsletter" class="button_mini" value="<?php echo $objlang->get("button_ok");?>">
