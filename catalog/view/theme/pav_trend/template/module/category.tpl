<div class="box category">
    <div class="box-heading"><span><i class="fa fa-align-justify"></i><?php echo $heading_title; ?></span></div>
    <div class="box-content">
		<ul class="box-category list">
			...
			<li class="<?php echo $class; ?>">
				...
				<a class="subcart" data-toggle="collapse" data-parent="#accordion" href="#collapseOne<?php echo $k ;?>"></a>				
