    ...
    <div class="table-responsive">
      <table class="table table-bordered compare-info">
        ...
        <tr>
          <td></td>
          <?php foreach ($products as $product) { ?>
          <td class="text-center"><input type="button" value="<?php echo $button_cart; ?>" class="button" onclick="cart.addcart('<?php echo $product['product_id']; ?>');" />            
          <?php } ?>
        </tr>
        <tr>
          <td></td>
          <?php foreach ($products as $product) { ?>
          <td class="remove text-center"><a href="<?php echo $product['remove']; ?>" class="btn button"><?php echo $button_remove; ?></a></td>
          <?php } ?>
        </tr>
      </table>
    </div>
