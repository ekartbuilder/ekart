...
<div class="column-image col-lg-4 col-md-4 col-sm-4 col-xs-12 pull-left image-container">
    ...
    <?php if ($images) { ?>
     <div class="image-additional slide carousel vertical" id="image-additional">
        ...
        ?>
        <a class="carousel-control left" href="#image-additional" data-slide="prev"><i class="fa fa-chevron-left"></i></a>
        <a class="carousel-control right" href="#image-additional" data-slide="next"><i class="fa fa-chevron-right"></i></a>
        <?php } ?>
    </div>          
