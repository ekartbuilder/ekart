...
<div class="box-heading">
	<span class="pull-left"><?php echo $heading_title; ?>(<?php echo count($products); ?>)</span>
...
<div class="box-content">
	<div id="related" class="slide product-grid" data-interval="0">
		...
		<div class="carousel-controls">
			<a class="carousel-control left icon-angle-left" href="#related" data-slide="prev"><i class="fa fa-chevron-left"></i></a>
            <a class="carousel-control right icon-angle-right" href="#related" data-slide="next"><i class="fa fa-chevron-right"></i></a>
		</div>
		<?php } ?>
